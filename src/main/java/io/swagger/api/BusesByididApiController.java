...
@RestController
public class BusesByididApiController implements BusesByididApi {

    private static final Logger log = LoggerFactory.getLogger(BusesByididApiController.class);
    ...
    public BusesByididApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Bus> getBusById(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") Integer id) {
