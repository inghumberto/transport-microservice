...
@Validated
public interface BusescostumeApi {

    @Operation(summary = "Obtiene un autobus por su id", description = "", tags={ "Autobuses" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Existe el autobus", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Bus.class))),
