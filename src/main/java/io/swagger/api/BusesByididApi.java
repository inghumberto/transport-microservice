...
@Validated
public interface BusesByididApi {
    ...
    @RequestMapping(value = "/busesByid={id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Bus> getBusById(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") Integer id);
