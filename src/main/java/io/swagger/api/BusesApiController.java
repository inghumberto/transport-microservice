...
public class BusesApiController implements BusesApi {
    ...
    public ResponseEntity<Bus> addBus(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Bus body) {
    ...
    public ResponseEntity<Response> deleteBus(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") Integer id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<Bus> modifyBus(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Bus body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Bus>(objectMapper.readValue("{\n  \"code\" : \"E-11\",\n  \"buydate\" : \"2015-01-01T00:00:00.000+00:00\",\n  \"line\" : {\n    \"size\" : 6.0274563,\n    \"color\" : \"rojo\",\n    \"name\" : \"Jarazmín - El Palo\",\n    \"active\" : true,\n    \"id\" : 25,\n    \"creation\" : \"2000-01-23T04:56:07.000+00:00\"\n  },\n  \"consumption\" : 0.8008282,\n  \"id\" : 542,\n  \"doublebus\" : true,\n  \"capacity\" : 80,\n  \"passengerSet\" : [ null, null ]\n}", Bus.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Bus> modifybusCode(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") Integer id,@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody String body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Bus>(objectMapper.readValue("{\n  \"code\" : \"E-11\",\n  \"buydate\" : \"2015-01-01T00:00:00.000+00:00\",\n  \"line\" : {\n    \"size\" : 6.0274563,\n    \"color\" : \"rojo\",\n    \"name\" : \"Jarazmín - El Palo\",\n    \"active\" : true,\n    \"id\" : 25,\n    \"creation\" : \"2000-01-23T04:56:07.000+00:00\"\n  },\n  \"consumption\" : 0.8008282,\n  \"id\" : 542,\n  \"doublebus\" : true,\n  \"capacity\" : 80,\n  \"passengerSet\" : [ null, null ]\n}", Bus.class), HttpStatus.NOT_IMPLEMENTED);
