...
@RestController
public class BusStopByididApiController implements BusStopByididApi {

    private static final Logger log = LoggerFactory.getLogger(BusStopByididApiController.class);
    ...
    public BusStopByididApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<BusStop> getBusStopById(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") Integer id) {
